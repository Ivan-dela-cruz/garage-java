...
import reportes.ReporteIngresosHoras;

/**
 *
 * @author Administrador
 */
public class ConsultasRegistrosHoras extends javax.swing.JInternalFrame {

    public static Connection sql;
    public static Statement s;

    public ConsultasRegistrosHoras() {
        initComponents();
    ...
    void Cargarlistaclientes() {
        ...
        String[] Titulos = {"CÓDIGO", "CÉDULA",  "PLACA", "FECHA", "ENTRADA", "SALIDA", "HORAS", "TOTAL"};
        ...
        try {
            ...
            String ConsultaSQL = "SELECT cliente_hora.cod_barras, cliente_hora.ci,cliente_hora.placa,entradashoras.fecha,entradashoras.hora_llegada, entradashoras.hora_salida, pagoshoras.horas,pagoshoras.tota FROM pagoshoras, cliente_hora, entradashoras WHERE entradashoras.fecha = '" + fechaactual() + "' AND entradashoras.estado ='Salida' AND entradashoras.id_hora = cliente_hora.id AND pagoshoras.id_entrada=entradashoras.id";
            ...
            while (rs.next()) {
                ...
                registros[4] = rs.getString("hora_llegada");
                registros[5] = rs.getString("hora_salida");
                registros[6] = rs.getString("horas");
                registros[7] = rs.getString("tota");
            ...
            Logger.getLogger(ConsultasRegistrosHoras.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("INGRESOS DE CLIENTES POR HORAS");
...
public String getFechaFin() {
    ...
    public void sumar() {
        ...
        for (int i = 0; i < tbclientes.getRowCount(); i++) {
            filas = tbclientes.getValueAt(i, 7).toString();
...
// TODO add your handling code here:
    ...
    if (rdfecha.isSelected() == true) {
        ...
        try {
            String[] registros = new String[10];
            s = sql.createStatement();
            String ConsultaSQL = "SELECT cliente_hora.cod_barras, cliente_hora.ci,cliente_hora.placa,entradashoras.fecha,entradashoras.hora_llegada, entradashoras.hora_salida, pagoshoras.horas,pagoshoras.tota FROM pagoshoras, cliente_hora, entradashoras WHERE entradashoras.fecha = '" + getFechaFin() + "' AND entradashoras.estado ='Salida' AND entradashoras.id_hora = cliente_hora.id AND pagoshoras.id_entrada=entradashoras.id";
    ...
    if (rddni.isSelected() == true) {
        ...
        try {
            String[] registros = new String[10];
            s = sql.createStatement();
            String ConsultaSQL = "SELECT cliente_hora.cod_barras, cliente_hora.ci,cliente_hora.placa,entradashoras.fecha,entradashoras.hora_llegada, entradashoras.hora_salida, pagoshoras.horas,pagoshoras.tota FROM pagoshoras, cliente_hora, entradashoras WHERE cliente_hora.ci = '" + txtdni.getText() + "' AND  entradashoras.fecha = '" + getFechaFin() + "' AND entradashoras.estado ='Salida' AND entradashoras.id_hora = cliente_hora.id AND pagoshoras.id_entrada=entradashoras.id";
            ResultSet rs = s.executeQuery(ConsultaSQL);
    ...
    if (intervalos.isSelected() == true) {
        if (txtdni.getText().equalsIgnoreCase("")) {
            ...
            try {
                String[] registros = new String[10];
                s = sql.createStatement();
                String ConsultaSQL = "SELECT cliente_hora.cod_barras, cliente_hora.ci,cliente_hora.placa,entradashoras.fecha,entradashoras.hora_llegada, entradashoras.hora_salida, pagoshoras.horas,pagoshoras.tota FROM pagoshoras, cliente_hora, entradashoras WHERE entradashoras.fecha BETWEEN '" + getFechaInicio() + "' AND '" + getFechaInicioInter() + "' AND  entradashoras.estado ='Salida' AND entradashoras.id_hora = cliente_hora.id AND pagoshoras.id_entrada=entradashoras.id";
                ResultSet rs = s.executeQuery(ConsultaSQL);
            ...
            try {
                String[] registros = new String[10];
                s = sql.createStatement();
                String ConsultaSQL = "SELECT cliente_hora.cod_barras, cliente_hora.ci,cliente_hora.placa,entradashoras.fecha,entradashoras.hora_llegada, entradashoras.hora_salida, pagoshoras.horas,pagoshoras.tota FROM pagoshoras, cliente_hora, entradashoras WHERE entradashoras.fecha BETWEEN '" + getFechaInicio() + "' AND '" + getFechaInicioInter() + "' AND clientes_hora.ci = '"+txtdni.getText()+"' AND entradashoras.estado ='Salida' AND entradashoras.id_hora = cliente_hora.id AND pagoshoras.id_entrada=entradashoras.id";
                ResultSet rs = s.executeQuery(ConsultaSQL);
...
private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
    ...
    try {
        // TODO add your handling code here:
        List<ReporteIngresosHoras> listaclientes = new ArrayList<ReporteIngresosHoras>();
        ...
        for (int i = 0; i < filas; i++) {
            ReporteIngresosHoras p = new ReporteIngresosHoras(
        ...
        JasperReport reporte = (JasperReport) JRLoader.loadObject("ReporteHoras.jasper");
        ...
        exporter.setParameter(JRExporterParameter.OUTPUT_FILE, new java.io.File("ReporteHoras.pdf"));
